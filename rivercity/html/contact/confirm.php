...
<title>River City Clinic［がん先進治療、がん予防・再発防止、がん超早期発見検査］</title>
<!-- icon -->
...
<script defer src="com.js"></script>
<!-- intersection observer -->
<script defer src="intersection-observer-polyfill.js"></script>
<script>
$(function() {
...
<!-- matchHeight -->
<script defer src="jquery.matchHeight.js"></script>
<script>
$(function() {
...
<header>
	<div class="header_bar">
		<h1><a href="/"><img src="../images/header-logo.png" alt="りんくうメディカルクリニック［がん先進治療、がん予防・再発防止、がん超早期発見検査］"></a></h1>
	</div><!-- /header_bar -->
</header>
<main>
			...
			<form id="application" action="./complete.php" method="post">
				...
				<div class="form_area">
					<dl> 
						...
						<dd class="name">あ あ</dd>
						<dt>フリガナ<span>必須</span></dt>
						<dd class="name">ア ア</dd>
						...
						<dd>
							<strong>第一希望</strong>
							<p>・2020年10月13日　11:30〜12:30</p>
							<strong>第二希望</strong>
							<p>・2020年10月06日　15:30〜16:30</p>
						</dd>
						<dt>その他</dt>
						<dd>（未入力）</dd>
					</dl>
				...
				<div class="btn_wrap">
					<div class="backBtn"><a href="contact.html">&laquo;&nbsp;戻る</a></div>
					<div class="submitBtn"><input type="submit" id="submit_go" value="送信する"></div>
				</div>
<input type="hidden" name="ご相談内容・がん先進治療[]" value="がん遺伝子治療">
<input type="hidden" name="ご相談内容・がん先進治療[]" value="高分子抗がん剤">
<input type="hidden" name="ご相談内容・がん予防・再発防止" value="">
<input type="hidden" name="ご相談内容・がん超早期発見検査" value="">
<input type="hidden" name="ご相談内容・その他[]" value="セカンドオピニオン">
<input type="hidden" name="性別" value="男性">
<input type="hidden" name="お電話可能な時間帯" value="18時～19時">
<input type="hidden" name="お名前" value="あ">
<input type="hidden" name="お名前・名" value="あ">
<input type="hidden" name="フリガナ" value="ア">
<input type="hidden" name="フリガナ・名" value="ア">
<input type="hidden" name="年齢" value="12">
<input type="hidden" name="第一希望日" value="2020年10月13日">
<input type="hidden" name="第一希望時間" value="11:30〜12:30">
<input type="hidden" name="第二希望日" value="2020年10月06日">
<input type="hidden" name="第二希望時間" value="15:30〜16:30">
<input type="hidden" name="電話番号" value="234">
<input type="hidden" name="電話番号2" value="333">
<input type="hidden" name="電話番号3" value="4444">
<input type="hidden" name="メールアドレス" value="prgfinal216@gmail.com">
<input type="hidden" name="メールアドレス（確認）" value="prgfinal216@gmail.com">
<input type="hidden" name="診察について" value="再診">
<input type="hidden" name="住所" value="あ">
<input type="hidden" name="かかりつけ" value="あ">
<input type="hidden" name="ご紹介者" value="">
<input type="hidden" name="その他" value="">
                <input type="hidden" name="token" value="f346dce6574892e21976b3635c727ab8">
			</form>
		</div><!-- /contactCotainer -->
	</section><!-- /inner -->
</main>
