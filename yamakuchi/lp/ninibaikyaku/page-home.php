	...
	<div class="banner slider">
		...
		<div>
			<div class="banner_image banner_slide_second">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/banner-2.jpg">
				<div class="banner_text">
					<h1>
						費用は0円<br>
						持ち出しは一切なし
		...
		<div>
			<div class="banner_image banner_slide_third">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/banner-3.jpg">
				<div class="banner_text">
					<h1>
						そのまま住み続ける<br>
						こともできる
				...
				<div class="voluntary_sale_inner_text_second">
					<div class="voluntary_sale_video">
						<div class="voluntary_sale_video_innre">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/f4bL6t734D8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
					</div>
	...
	<div class="custom_container">
		...
		<div class="benefits_box_sec">
			...
			<div class="our_vision_box_btn front_merit">
                <a href="<?php echo get_site_url(); ?>/step">ご相談から解決までの<br>流れを知りたい方はこちら <i class="fa fa-chevron-right"></i></a>
            </div>
		</div>
	</div>
</section>
	...
	<div class="service_box_text_image_sec">
		<div class="service_box_inner_image">
			<div class="service_box_inner_image_inner">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-image.jpg">
			</div>
		</div>
		...
		<div class="custom_container">
			<div class="custom_row">
				<div class="custom_col_4">
					<div class="service_box">
						<div class="service_box_image">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-1.jpg">
						</div>
				...
				<div class="custom_col_4">
					<div class="service_box">
						<div class="service_box_image">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-2.jpg">
						</div>
						<div class="service_box_text">
				...
				<div class="custom_col_4">
					<div class="service_box">
						<div class="service_box_image">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-3.jpg">
						</div>
						<div class="service_box_text">
				...
				<div class="custom_col_4">
					<div class="service_box">
						<div class="service_box_image">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-4.jpg">
						</div>
						<div class="service_box_text">
				...
				<div class="custom_col_4">
					<div class="service_box">
						<div class="service_box_image">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-5.jpg">
						</div>
						<div class="service_box_text">
							<h5>売って終わりではありません</h5>
				...
				<div class="custom_col_4">
					<div class="service_box">
						<div class="service_box_image">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/service-6.jpg">
						</div>
						<div class="service_box_text">
							<h5>セカンドオピニオン</h5>
...
?>
								<tr class="news_item js_button" data-href="<?php echo $loop_link; ?>">
...
if($fetch_query->have_posts()) : 
    while ($fetch_query->have_posts()) : 
        ...
        if($loop_toporder > 0){
            array_push($faq_list, array('id'=>$loop_id, 'order'=>$loop_toporder));
        }
    endwhile;
endif;
...
?>
								...
								<h3> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/q-image.png"> <?php echo $loop_question; ?></h3>
								<div>
									<p><a href="<?php echo get_site_url().'/faq/?scrollid='.$loop_id; ?>">
