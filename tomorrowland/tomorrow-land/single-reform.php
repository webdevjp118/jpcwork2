<?php
/**
 * The template for displaying all reform posts
 *
...
<section class="blog_sec">
    <div class="custom_container_medium">
        <p><a class="pankuzu" href="<?php echo get_site_url(); ?>">ホーム</a> / <a class="pankuzu" href="<?php echo get_site_url(); ?>/reform">リフォーム事例</a> / <?php echo $title; ?></p>
