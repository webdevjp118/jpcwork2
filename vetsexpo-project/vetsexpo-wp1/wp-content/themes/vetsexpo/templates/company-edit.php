...
<div class="imgupload-div">
    ...
    <input type="file" title="" class="delete-file" name="company_logo" data-spec="company_logo"/>
...
<table>
    <tbody>
        ...
        <tr>
            <th class="_heading"><div>製品説明</div></th>
            <td class="_content" colspan="2">
                <div>
                <textarea placeholder="" rows="4" cols="50" name="<?php echo 'product'.$i.'_desc'; ?>" ><?php echo $product['product'.$i.'_desc']; ?></textarea>
                </div>
            </td>
        </tr>
    </tbody>
