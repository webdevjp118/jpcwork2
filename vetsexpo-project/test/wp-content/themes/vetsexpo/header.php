...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/css/cssreset.css" media="all">
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/css/html5-doctor-reset-stylesheet.min.css" media="all">
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/css/com.css" media="all">
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/css/flexslider.css" media="all">
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri();?>/css/main.css" media="all">
<!-- Javascript -->
...
<!--[if lt IE 9]>
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/IE9.js"></script>
...
<body id="PAGETOP" <?php body_class(array('transition', 'contents', 'contact')); ?>>
...
if($menu_query->have_posts()) {
	while($menu_query->have_posts()){
		...
		$company_list[] = array('id'=>$loop_id, 'name'=>$loop_name);
	}
}
wp_reset_query();
?>
...
<header>
	<div class="header_bar">
		<h1><a href="<?php echo get_site_url(); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/top-logo.svg" alt="sitename_replace"></a></h1>
		<ul class="header_menu">
			<li id="header-submenu0"><a href="<?php echo get_site_url(); ?>/">TOP</a></li>
			<li id="header-submenu1"><span>出展企業ページ</span>
			</li>
			<li id="header-submenu2"><span>お問い合わせ</span></li>
			<?php if( current_user_can('editor') || current_user_can('administrator') ) {  ?>
				<li><a href="<?php echo get_site_url(); ?>/company-edit">出展企業登録</a></li>
				<?php	if(get_option('booth_expired') == 'expired') { ?>
				<li><a href="<?php echo get_site_url(); ?>/expired">イベントオープン</a></li>
				<?php 	} else { ?>
				<li><a href="<?php echo get_site_url(); ?>/expired">イベント終了</a></li>
				<?php 	} ?>
			<?php } ?>
		</ul>
	</div><!-- /header_bar -->
...
<?php foreach($company_list as $company): ?>		
		<a href="<?php echo get_site_url().'/company/'.$company['id']; ?>"><?php echo $company['name']; ?></a>
<?php endforeach; ?>
	</div>
	<div class="submenu" id="submenu2">
<?php foreach($company_list as $company): ?>		
		<a href="<?php echo get_site_url().'/contact/?id='.$company['id']; ?>"><?php echo $company['name']; ?></a>
<?php endforeach; ?>
	</div>
  ...
  <div id="nav_btnwrapper"><div id="nav_btn"><span id="nav_btn_icon"></span></div></div>
	<nav>
		<div class="nav_inner">
      <ul class="header_menu">
        <li class="m_header-item" id="m_header-item1"><a href="<?php echo get_site_url(); ?>">TOP</a></li>
        <li class="m_header-item" id="m_header-item2"><span id="m_header-submenu1">出展企業ページ</span></li>
        <li class="m_header-item" id="m_header-item3"><span id="m_header-submenu2">お問い合わせ</span></li>
      </ul>
		</div>
		<div class="m_submenu" id="m_submenu1">
			<ul>
<?php foreach($company_list as $company): ?>
				<li><a href="<?php echo get_site_url().'/company/'.$company['id']; ?>"><?php echo $company['name']; ?></a></li>
<?php endforeach; ?>
			</ul>
		</div>
		<div class="m_submenu" id="m_submenu2">
			<ul>
<?php foreach($company_list as $company): ?>
				<li><a href="<?php echo get_site_url().'/contact/?id='.$company['id']; ?>"><?php echo $company['name']; ?></a></li>
<?php endforeach; ?>
			</ul>
		</div>
	</nav>
