...
$(function() {
	...
	$("img").on("taphold",function(event){ event.preventDefault(); });
	...
	if(location.pathname.indexOf("company") != -1) {
		$("#header-submenu1").addClass('menu-active');
	}
	else if(location.pathname.indexOf("contact") != -1 || location.pathname.indexOf("confirm") != -1 || location.pathname.indexOf("complete") != -1) {
		$("#header-submenu2").addClass('menu-active');
	}
	else {
		$("#header-submenu0").addClass('menu-active');
	}
	...
	// $('#header-submenu1, #submenu1').mouseenter( function() {$('#submenu1').css({display:'block'});} ).mouseleave( function() {$('#submenu1').css({display:'none'});} );
	$('#header-submenu1, #submenu1').mouseenter( function() {
			$('#submenu1').addClass('submenu-active');
	}).mouseleave( function() {
		$('#submenu1').removeClass('submenu-active');
	});
	$('#header-submenu2, #submenu2').mouseenter( function() {
		$('#submenu2').addClass('submenu-active');
	}).mouseleave( function() {
		$('#submenu2').removeClass('submenu-active');
	});

	$('#m_header-submenu1').click( function() {
		console.log("hello");
		$('#m_submenu1').addClass('m_submenu-active');
		$('#m_submenu2').removeClass('m_submenu-active');
		$('.m_header-item').removeClass('m_header-item-active');
		$('#m_header-item2').addClass('m_header-item-active');
	});
	$('#m_header-submenu2').click( function() {
		$('#m_submenu1').removeClass('m_submenu-active');
		$('#m_submenu2').addClass('m_submenu-active');
		$('.m_header-item').removeClass('m_header-item-active');
		$('#m_header-item3').addClass('m_header-item-active');
	});
/*---------------------------------------------------
	SNIPPETS
---------------------------------------------------*/
