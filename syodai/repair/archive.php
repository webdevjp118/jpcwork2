...
$page_title_class = "";
if(is_tag()) {
	$page_title = single_term_title('', false)."の記事";
	$page_title_class = "tag_titled";
} 
else if(is_category()) {
...
?>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-taghello-taghello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li><li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                    <li><a class="tag_button" href="javascript:void(0)">hello-tag</a></li>
                </ul>
    ...
    <div class="custom_container">
        <div class="custom_row">
            <div class="article_col">
                <h2 class="<?php echo $page_title_class; ?>"><?php echo $page_title; ?></h2>
...
?>
                ...
                <div class="custom_pagination">
                    <ul>
                        <li><a href="<?php echo $prev_link; ?>"><svg class="svg_l_arrow0"><use xlink:href="#svg_l_arrow0"></use></svg></a></li>
                        <li><p><span class="active_page"><?php echo $pageno; ?></span><?php echo ' / '.$page_count; ?></p></li>
                        <li><a href="<?php echo $next_link; ?>"><svg class="svg_r_arrow0"><use xlink:href="#svg_r_arrow0"></use></svg></a></li>
                    </ul>
                </div>
            </div>
			<?php get_sidebar(); ?>
