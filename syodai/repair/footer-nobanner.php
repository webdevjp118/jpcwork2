...
<footer class="site_footer">
	<div class="businesses_box_sec" style="padding-top:20px;">
		<div class="custom_container">
			<div class="footer_logo">
				<a style="margin-top:0;" href="<?php echo get_site_url(); ?>/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo.svg"></a>
			</div>
		</div>
	</div>
