...
<script>
	var person_list = [{
		...
		name: '楠本正幸',
		jobtitle: 'NTT都市開発株式会社 顧問',
		bio: "1979年東京大学工学部建築学科卒、日本電電公社入社。1982年よりパリ・ラ・ヴィレット建築大学院へ留学、1985年フランス政府公認建築家の資格取得。1988年以降NTT都市開発にて商業、ホテル、グローバル事業等を牽引。2017年同社代表取締役副社長、チーフ・デザイン・オフィサー。2019年NTTアーバンソリューションズ取締役副社長を兼任。2020年6月より現職。",
	}, {
		id: 17,
        ...
        <div data-barba="wrapper">
            <div data-barba="container" data-barba-namespace="page-top">
                <div class="topIndexArea topIndexAreaSlider">
					<a href="https://schoo.jp/class/7078" class="float-banner" id="float-banner">
                        Schooオンライン<br>会場はこちら
                    </a>
                    <div class="event-titlediv">
                        <img src="/wp/wp-content/uploads/2020/06/event-title1.png">
                    </div>
                    <!--<a href="https://netsui.or.jp/magazine" class="mail-register">熱意ある地方創生ベンチャー連合<br>メルマガ登録はこちら</a>-->
                                    ...
                                    <div class="c-hksd-slider_inner">
                                        <div class="c-hksd-slider_slide active">
                                            <div class="c-hksd-slider_slide_inner">
                                                <figure>
                                                    <picture>
                                                        <source class="img" media="(max-width: 767px)" srcset="/wp/wp-content/uploads/2020/06/IMGLP20200610-1_sp.jpg">
                                                        <img class="js-rq-image objectFitImg01 img" src="/wp/wp-content/uploads/2020/06/IMGLP20200610-1.jpg" alt="">
                                                    </picture>
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="c-hksd-slider_slide">
                                            <div class="c-hksd-slider_slide_inner">
                                                <figure>
                                                    <picture>
                                                        <source class="img" media="(max-width: 767px)" srcset="/wp/wp-content/uploads/2020/06/IMGLP20200610-2_sp.jpg">
                                                        <img class="js-rq-image objectFitImg02 img" src="/wp/wp-content/uploads/2020/06/IMGLP20200610-2.jpg" alt="">
                                                    </picture>
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="c-hksd-slider_slide pre">
                                            <div class="c-hksd-slider_slide_inner">
                                                <figure>
                                                    <picture>
                                                        <source class="img" media="(max-width: 767px)" srcset="/wp/wp-content/uploads/2020/06/IMGLP20200610-3_sp.jpg">
                                                        <img class="js-rq-image objectFitImg03 img" src="/wp/wp-content/uploads/2020/06/IMGLP20200610-3.jpg" alt="">
                                                    </picture>
                                                </figure>
                                            </div>
                                        </div>
...
<div class="entry-content">
	<div class="lp-introduce">
		<div class="inner">
			<div class="desktop-content">
				<p>
					2014年9月に発足した第二次安倍内閣より掲げられた「地方創生」というテーマ。
					<br> 熱意ある地方創生ベンチャー連合及びスタートアップ都市推進協議会は、
					<br> 地方創生の流れをさらに加速化させるために、国・自治体・民間事業者それぞれの
					<br> 立場から地方創生に対する現状や課題の共有、今後に期待される新たな事例の発信や
					<br> 交流を行うための「地方創生ベンチャーサミット」を毎年開催しております。
					<br>
					<br> ５回目の開催となる今回は、「地方創生をアップデートせよ」という大きなテーマを掲げています。
					<br> 各領域の第一線で活躍する地方創生のキーマン・有識者・ベンチャー企業の経営者、そ自治体の
					<br> トップらが一同に集い、熱量の高いトークを繰り広げます。
					<br>
					<br> これからの地域や企業の目指すべき姿、
					<br> そのための施策やヒントを探されている皆さまをはじめ、
					<br> 日本の未来や地方創生の分野に関心のある幅広い方々のご参加をお待ちしております！
					<br>
					<br>
				</p>
			</div>
			<div class="mobile-content">
				<p>
					...
					<br>「地方創生」というテーマ。
					<br>熱意ある地方創生ベンチャー連合及びスタートアップ
					<br>都市推進協議会は、
					<br>地方創生の流れをさらに加速化させるために、
					<br>国・自治体・民間事業者それぞれの
					<br>立場から地方創生に対する現状や課題の共有、
					<br>今後に期待される新たな事例の発信や
					<br>交流を行うための「地方創生ベンチャーサミット」を
					<br>毎年開催しております。
					<br>
					<br>５回目の開催となる今回は、
					<br>「地方創生をアップデートせよ」
					<br>という大きなテーマを掲げています。
					<br>各領域の第一線で活躍する地方創生の
					<br>キーマン・有識者・ベンチャー企業の経営者、
					<br>そ自治体のトップらが一同に集い、
					<br>熱量の高いトークを繰り広げます。
					<br>
					<br>これからの地域や企業の目指すべき姿、
					<br>そのための施策やヒントを
					<br>探されている皆さまをはじめ、
					<br>日本の未来や地方創生の分野に関心のある
					<br>幅広い方々のご参加をお待ちしております！
					<br>
					<br>
				</p>
			</div>
			<p><img src="/wp/wp-content/uploads/2020/06/IMGLP20200610-00.jpg"></p>
			<p><a href="https://schoo.jp/class/7078" class="online-register">オンライン会場はこちら</a></p>
		</div>
	</div>
	<div class="lp-logo">
		<div class="inner">
			<p><img src="/wp/wp-content/uploads/2020/06/logoandschoo.jpg"></p>
			<div class="desktop-content">
				<p>
					オンライン学習サービスのSchooとコラボして<br> 地方創生ベンチャーサミットはオンラインで開催いたします。
					<br> 当日は１１：３０から１９：２０まで、地方創生をテーマに７つのセッションを一挙生放送します。
					<br> 参加無料でどなたでもどこからでもご参加いただけます。ぜひご視聴ください。
					<br>
			...
			<div class="mobile-content">
				<p>
					オンライン学習サービスのSchooとコラボして
					<br>地方創生ベンチャーサミットは
					<br>オンラインで開催いたします。
					<br>当日は１１：３０から１９：２０まで、
					<br>地方創生をテーマに７つのセッションを
					<br>一挙生放送します。
					<br>参加無料でどなたでもどこからでも
					<br>ご参加いただけます。ぜひご視聴ください。
					<br>
			...
			<div class="desktop-content">
				<p>
					「地方創生」をテーマに、<br> 行政とベンチャー企業との架け橋となり、
					<br> みなさんと共に新時代を切り拓きます。
					<br> 労働人口の減少・事業の後継者不足・空き家の増加・オーバーツーリズム…
					<br> 前例のない社会課題が顕在化しています。
					<br> 行政だからこそできること、
					<br> そしてベンチャー企業だからこそできることがあるのではないでしょうか。
					<br> 地方創生に熱意を持って取り組む約50社のベンチャーがあつまった団体です。
					<br> 地方創生に取り組むベンチャー企業の参画を募集しています。
					<br>
				</p>
			</div>
			<div class="mobile-content">
				<p>
					「地方創生」をテーマに、
					<br>行政とベンチャー企業との架け橋となり、
					<br>みなさんと共に新時代を切り拓きます。
					<br>労働人口の減少・事業の後継者不足・
					<br>空き家の増加・オーバーツーリズム…
					<br>前例のない社会課題が顕在化しています。
					<br>行政だからこそできること、
					<br>そしてベンチャー企業だからこそできることが
					<br>あるのではないでしょうか。
					<br>地方創生に熱意を持って取り組む約50社の
					<br>ベンチャーがあつまった団体です。
					<br>地方創生に取り組むベンチャー企業の
					<br>参画を募集しています。
					<br>
				</p>
			</div>
	...
	<div class="lp-speakers">
		<div class="inner">
			<div class="lp-sectiontitle">
				<p class="background double "><span>ご登壇者</span></p>
			</div>
			<div class="flex-container ">
				<div class="person-item modal-toggle" person-id="1">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_01.jpg ">
					</div>
					<p class="person-name ">山野智久</p>
					<p class="person-detail ">（一社）熱意ある地方創生ベンチャー連合 共同代表理事 / アソビュー株式会社 代表取締役 CEO</p>
				</div>
				<div class="person-item modal-toggle" person-id="2">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_02.jpg ">
					</div>
					<p class="person-name ">秋好陽介</p>
					<p class="person-detail ">（一社）熱意ある地方創生ベンチャー連合 共同代表理事 / ランサーズ株式会社 代表取締役CEO</p>
				</div>
				<div class="person-item modal-toggle" person-id="3">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_03.jpg ">
					</div>
					<p class="person-name ">高島宗一郎</p>
					<p class="person-detail ">福岡市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="5">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_05.jpg ">
					</div>
					<p class="person-name ">森まさこ</p>
					<p class="person-detail ">法務大臣</p>
				</div>
				<div class="person-item modal-toggle" person-id="4">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_04.jpg ">
					</div>
					<p class="person-name ">米良はるか</p>
					<p class="person-detail ">READYFOR株式会社 代表取締役 CEO</p>
				</div>
				<div class="person-item modal-toggle" person-id="7">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_07.jpg ">
					</div>
					<p class="person-name ">仲川げん</p>
					<p class="person-detail ">奈良市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="8">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_08.jpg ">
					</div>
					<p class="person-name ">湯崎英彦</p>
					<p class="person-detail ">広島県知事</p>
				</div>
				<div class="person-item modal-toggle" person-id="9">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_09.jpg ">
					</div>
					<p class="person-name ">太田直樹</p>
					<p class="person-detail ">株式会社NewStories代表・総務省政策アドバイザー</p>
				</div>
				<div class="person-item modal-toggle" person-id="10">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_10.jpg ">
					</div>
					<p class="person-name ">津田大介</p>
					<p class="person-detail ">ジャーナリスト／メディア・アクティビスト</p>
				</div>
				<div class="person-item modal-toggle" person-id="11">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_11.jpg ">
					</div>
					<p class="person-name ">鈴木英敬</p>
					<p class="person-detail ">三重県知事</p>
				</div>
				<div class="person-item modal-toggle" person-id="12">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_12.jpg ">
					</div>
					<p class="person-name ">鈴木康友</p>
					<p class="person-detail ">浜松市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="13">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_13.jpg ">
					</div>
					<p class="person-name ">倉林啓士郎</p>
					<p class="person-detail ">FC琉球 取締役会長</p>
				</div>
				<div class="person-item modal-toggle" person-id="14">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_14.jpg ">
					</div>
					<p class="person-name ">高橋靖</p>
					<p class="person-detail ">水戸市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="15">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_15.jpg ">
					</div>
					<p class="person-name ">重松大輔</p>
					<p class="person-detail ">株式会社スペースマーケット 代表取締役CEO</p>
				</div>
				<div class="person-item modal-toggle" person-id="16">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_16.jpg ">
					</div>
					<p class="person-name ">楠本正幸</p>
					<p class="person-detail ">NTT都市開発株式会社 顧問</p>
				</div>
				<div class="person-item modal-toggle" person-id="17">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_17.jpg ">
					</div>
					<p class="person-name ">熊谷俊人</p>
					<p class="person-detail ">千葉市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="18">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_18.jpg ">
					</div>
					<p class="person-name ">﨑田恭平</p>
					<p class="person-detail ">日南市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="19">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_19.jpg ">
					</div>
					<p class="person-name ">林篤志</p>
					<p class="person-detail ">Next Commons Lab 代表</p>
				</div>
				<div class="person-item modal-toggle" person-id="20">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_20.jpg ">
					</div>
					<p class="person-name ">井上高志</p>
					<p class="person-detail ">株式会社LIFULL 代表取締役社長</p>
				</div>
				<div class="person-item modal-toggle" person-id="21">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_21.jpg ">
					</div>
					<p class="person-name ">長野恭紘</p>
					<p class="person-detail ">別府市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="22">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_22.jpg ">
					</div>
					<p class="person-name ">吉田雄人</p>
					<p class="person-detail ">一般社団法人熱意ある地方創生ベンチャー連合事務局長</p>
				</div>
				<div class="person-item modal-toggle" person-id="23">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_23.jpg ">
					</div>
					<p class="person-name ">東修平</p>
					<p class="person-detail ">四條畷市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="24">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_24.jpg ">
					</div>
					<p class="person-name ">五十嵐立青</p>
					<p class="person-detail ">つくば市長</p>
				</div>
				<div class="person-item modal-toggle" person-id="25">
					<div class="__thumb ">
						<img src="/wp/wp-content/uploads/2020/06/speaker_25.jpg ">
					</div>
					<p class="person-name ">伊藤徳宇</p>
					<p class="person-detail ">桑名市長</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="schedule-itemdiv flex-container ">
					...
					<div class="schedule-right ">
						...
						<div class="scheduleperson-div flex-container ">
							...
							<div class="scheduleperson-info ">
								<p class="scheduleperson-name ">﨑田恭平（ビデオ出演）</p>
					...
					<div class="schedule-right ">
						...
						<div class="scheduleperson-div flex-container ">
							...
							<div class="scheduleperson-info ">
								...
								<p class="scheduleperson-detail ">NTT都市開発株式会社 顧問</p>
							</div>
						</div>
						<div class="scheduleperson-div flex-container ">
