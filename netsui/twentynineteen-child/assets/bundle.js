$('.modal-toggle').on('click', function(e) {
    ...
    if (person_idx) {
        let msgbodyhtml = '<img class="msgpicture" src="/wp/wp-content/uploads/2020/06/' + personRec.imgname + '">';
        if(isValidObj(personRec.uploadtime)) {
            msgbodyhtml = '<img class="msgpicture" src="/wp/wp-content/uploads/'+ personRec.uploadtime +'/' + personRec.imgname + '">';
        }
