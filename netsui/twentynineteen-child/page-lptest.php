...
<div class="entry-content">
		...
		<div class="inner">
			...
			<div class="desktop-content">
				<p>
					...
					<br> 当日は１２：００から１９：３０まで、地方組成をテーマに７つのセッションを一挙生放送します。
			...
			<div class="mobile-content">
				<p>
					...
					<br>地方創生ベンチャーサミットは
					<br>オンラインで開催いたします。
					<br>当日は１２：００から１９：３０まで、
					<br>地方組成をテーマに７つのセッションを
					<br>一挙生放送します。
					<br>参加無料でどなたでもどこからでも
		...
		<div class="inner">
			...
			<div class="flex-container ">
				...
				<div class="person-item modal-toggle" person-id="16">
					...
					<p class="person-detail ">NTTアーバンソリューションズ株式会社 取締役副社長／NTT都市開発株式会社 代表取締役副社長</p>
				</div>
	...
	<div class="lp-hosting ">
		<div class="inner ">
			<div class="lp-sectiontitle ">
				<p class="background double"><span>主催</span></p>
			</div>
		</div>
