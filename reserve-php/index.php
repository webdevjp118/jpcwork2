...
<?php require('common/include/header.php'); ?>
<main>
		...
		<div class="contactCotainer">
			...
			<form id="application" action="./confirm.php" method="post">
				...
				<div class="attention">
					...
					<em>お電話でのお問い合せ</em>
					<p>TEL: <a href="tel:0724240024">0724-24-0024</a><br>受付時間　9:30～18:30（月～金）</p>
					<em>メールアドレスの記載について</em>
					<p>携帯電話のメールアドレスで、迷惑メールの設定をされている場合、<a href="mailto:info@rinku-medical-clinic.com">info@rinku-medical-clinic.com</a>からの受信が行えるよう、設定のご確認をお願い致します。</p>
				</div>
				
				<div class="privacypolicy">
					<h3>プライバシーポリシー</h3>
					<div class="scroll">
						<p>りんくうメディカルクリニック（以下当クリニック）は、個人の人格尊重の理念のもとに、ご利用される皆様のプライバシーを尊重し、個人情報の管理・保護に努めます。</p>
						<em>個人情報の収集について</em>
						...
						<em>［お問い合わせ先］</em>
						<p>りんくうメディカルクリニック<br>TEL: <a href="tel:0724240024">0724-24-0024</a><br>受付時間　9:30～18:30（月～金）</p>
					</div>
...
<?php require('common/include/footer.php'); ?>
</body>
</html>
<?php
// 不要セッションの削除
