...
function enqueue_footer_bar_scripts() {
  wp_enqueue_style( 'avant-footer-bar', get_template_directory_uri() . '/assets/css/footer-bar.min.css', false, version_num() );
  wp_enqueue_script( 'avant-footer-bar', get_template_directory_uri() . '/assets/js/footer-bar.min.js', array( 'jquery' ), version_num(), true );
}
