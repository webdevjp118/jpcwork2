...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_avant.xml';	
    $db_cache_field = 'avant-contempo-notifier-cache';
    $db_cache_field_last_updated = 'avant-contempo-notifier-last-updated';
