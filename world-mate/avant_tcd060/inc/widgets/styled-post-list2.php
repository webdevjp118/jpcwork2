        ...
        <ul class="p-post-list02">
          ...
          <li class="p-post-list02__item p-article10">
            <h3 class="p-article10__title">
              <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php echo is_mobile() ? wp_trim_words( get_the_title(), 38, '...' ) : wp_trim_words( get_the_title(), 40, '...' ); ?></a>
            </h3>
            <?php if ( $display_date ) : ?>
          ...
          <li class="p-post-list02__item p-article10">
            <h3 class="p-article10__title">
              <a href="<?php echo esc_url( $native_ad['url'] ); ?>" title="<?php echo esc_attr( $native_ad['title'] ); ?>"<?php if ( $native_ad['target'] ) { echo ' target="_blank"'; } ?>><?php echo wp_trim_words( $native_ad['title'], 40, '...' ); ?></a>
            </h3>
